...
<head>
    ...
    <style>
        .game_canvas { 
            background-image:url('<?php echo base_url('images/gamebg5_1.png')?>'); 
            ...
            padding-right:80px; 
            padding-bottom:90px;
            cursor: url("<?php echo base_url('images/white_cursor.png'); ?>"), auto;
        }
        .bottom-Bg{    
            bottom: 131px;
            left: 95px;
            position: absolute;
            width: 415px;
/*            background: url("<?php //echo base_url('images/green_brick.png'); ?>");*/
        }
        ...
        #svgRoot{
            height: 489px; left: 64px; position: absolute; top:30px; width: 471px;
        }
        .bottom-Bg img{display: inline-block;margin-left: -13px;}
        ...
        .play_css {position: absolute;z-index: 999;right: 480px;bottom: 360px;}

        /*#start_show img {float: right;margin-right: 172px;margin-top: 110px;}*/
    </style>
<!--</head>
<body> -->
            <audio id="audiotag1" src="<?php echo base_url('SoundFile/593325210.wav')?>" preload="auto" type ="audio/wav"></audio>
        ...
        <div class="ballinsert" id="ballinsert">
            <img id="loadingimage" src="<?php echo base_url('images/loader_img.gif'); ?>" style="display:none;">
        ...
        <div class="grid">
           <!--  <header>
            ...
            <div id="gameZone">
                ...
                <svg id="svgRoot">
                    <circle cx="200" cy="439" r="10" id="ball"/>
                    <rect id="pad" height="15px" width="110px" y="493" x="190"/>
                     <!-- <rect id="pad" height="15px" width="120px" x="10" y="10" rx="10" ry="20"/> -->
                </svg>
                <?php // Shashank added code ?>
                <div id='countdown' style=" display: block; margin: 0px auto; position: absolute;top: 40%;font-size: 40px;left: 50%;color:#E3AC72;font-weight: bold;font-family: Verdana;"></div> </center> <br><br>
                <?php // Shashank added code ?>
                <div id="stats">
                </div>
           ...
           <div class="bottom-Bg">
                <img src="<?php echo base_url('images/green_brick.png')?>" class="123" name="123" id="he" width="107px" height="30px">
                <img src="<?php echo base_url('images/green_brick.png')?>" class="234" name="234" id="hel" width="107px" height="30px">
                <img src="<?php echo base_url('images/green_brick.png')?>" class="345" name="345" id="hell" width="107px" height="30px">
                <img src="<?php echo base_url('images/green_brick.png')?>" class="456" name="456" id="hello" width="134px" height="30px">
           </div>
        </div>
    </div>
