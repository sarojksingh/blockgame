    ...
    <div id="contbody">
      ...
      <nav>
        <div class="nav_menu">
          ...
          <ul class="menu_right">
            <li><a id="newGame" class="<?php echo ($nav_act == 'play_for_fun')  ? 'select_bg' : ''; ?>" href="<?php echo base_url('play_game'); ?>#gameZone">play for fun </a></li>
      ...
      <section id="article">
		 ...
		 if($msg)
		  ...
		  ?>
          <div class="<?php echo $class; ?>" id="msg_flashdata"><?php echo $msg; ?><span class="close_btn">
			  <a href="javascript:void(0);" id="msg_close">X</a></span>
			  <div class="clear"></div>
			</div>
          <?php } ?>	 
