...
<!--            <img id="loadingimage" src="images/loader_img.gif" style="display:none;">-->
    ...
    <div class="game_canvas">
        <div class="grid">
           ...
           <div class="bottom-Bg">
              <img src="<?php echo base_url('images/green_brick.1.png'); ?>" class="123" name="123" data-uid="hello">
              ...
              <img src="<?php echo base_url('images/green_brick.1.png'); ?>" class="123" name="123" data-uid="hllo">
           </div>
        </div>
    </div>
