...
<!--            <img id="loadingimage" src="images/loader_img.gif" style="display:none;">-->
        ...
        <?php // Play Button ?>
        <div id="start_show">
         <a href="javascript:void(0)" class="play_css"><img src="<?php echo base_url('images/play2.png'); ?>" onclick="countdown(event, 'countdown')" height="80px" width="80px" id="omg"/></a>
         </div>
        <?php // Play Button ?>
    <div class="game_canvas">
        <div class="grid">
           ...
           <div class="bottom-Bg">
              <img src="<?php echo base_url('images/green_brick.1.png'); ?>" class="123" name="123"  id="he">
              <img src="<?php echo base_url('images/green_brick.1.png'); ?>" class="123" name="123"  id="hel">
              <img src="<?php echo base_url('images/green_brick.1.png'); ?>" class="123" name="123"  id="hell">
              <img src="<?php echo base_url('images/green_brick.1.png'); ?>" class="123" name="123"  id="hello">
           </div>
        </div>
    </div>
