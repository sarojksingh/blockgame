<head>
    ...
    <script type="text/javascript" src="<?php echo $this->config->item('gameserver_url') ?>/socket.io/socket.io.js"></script>
    <!--<link rel="stylesheet" href="css/main.css" />-->
    <script type="text/javascript">
	// $('a').bind('click keydown',function(event){		
		// var keycodevalue = event.keyCode;		
		// if(keycodevalue == 13 || event.which ==1) {
			// if(confirm("Game will be lost on leaving this page. Do you want to continue?")){
				// return true;
			// }else{
				// return false;
			// }
	...
	// });
		...
		//jQuery('.canvas_popups').html('THANKS FOR PLAYING<br />PLAY AGAIN?
			//<a class="yes_btn">&nbsp;</a><a class="no_btn">&nbsp;</a>');
			showCanvasPop('.convas_game_end',0);
			showCanvasPop('.canvas_form_block',0);
			//jQuery('.canvas_popups').click(showCanvasPop);
        });
	</script>
	<script type="text/javascript">
        Pong = {};
    ...
    <script type="text/javascript">	
		...
		var tournament_name = "";
		var keyRoomID =-1;
		var gameServerURL = "<?php echo $this->config->item('gameserver_url') ?>";		
													...
													gameObjects.isLoader= false;
														...
														if( RoundNumber != -1)
														{
															...
															if(!isConnected)
															{
																...
																isConnected = true;
																setTimeout(function(){isConnected = false},5000);
															}
														}
														else
														{
...
<body onkeydown="javascript:keyboard.handler(event);" onkeyup="javascript:keyboard.handlerRelease(event);">
    ...
    <div class="game_zone">
        ...
        <div class="game_canvas">
			...
			<img id="process_loader" style="display:none;" src="<?php echo base_url(); ?>images/loading-icon.gif" />
    ...
    <script>
		...
		<audio id="audio_id" preload="auto">  
        	<source  src="http://ec2-54-252-230-61.ap-southeast-2.compute.amazonaws.com/SoundFile/593325210.wav" type ="audio/wav"></source>        
