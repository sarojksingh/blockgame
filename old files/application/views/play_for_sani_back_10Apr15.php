    ...
    <style>
        .game_canvas { 
            background-image:url('images/gamebg5_12_1.png'); 
        ...
        .topCounter { text-align: center; margin: 10px auto 5px; font-family: 'gnuolane_rgregular'; color: #8a530b; font-size: 40px; 
        ...
        <?php // Play Button ?>
        <div id="start_show">
         <a href="javascript:void(0)" class="play_css"><img src="images/play2.png" onclick="countdown('countdown')" height="80px" width="80px" /></a>
         </div>
        <?php // Play Button ?>
           ...
           <!--  <header>
            ...
            <div id="gameZone">
                ...
                <svg id="svgRoot">
                    ...
                    <rect id="pad" height="15px" width="110px" y="100" x="190"/>
