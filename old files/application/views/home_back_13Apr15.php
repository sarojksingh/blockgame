...
<article class="contlog_matter clearfix">
  ...
  <?php if(sessionData('id') == 0) { ?>
          <div class="clearfix buttons_div_inner">
                <div class="btn_centr">
                    <span class="left right_margn"><a href="<?php echo base_url(); ?>register" class="wel_register_button register_btn"><img src="images/register_btn.png" alt="" border="0"  /></a></span>
                    <span class="left right_margn"><a href="<?php echo base_url(); ?>login" class="wel_login_button login_btn"><img src="images/login_btn.png" alt="" border="0"  /></a></span>
                </div>
          </div>
  <?php } ?>
  <div class="clear"></div>
