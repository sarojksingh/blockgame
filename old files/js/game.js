       ...
       // Getting elements
        ...
        function gameLoop(e) { 
            ...
            pad.setAttribute("y", 470);topcount
            // pad.setAttribute("x", padX);
        ...
        function generateBricks() {
            ...
            var offset = (478 - bricksCols * (brickWidth + bricksMargin)) / 2.0;
        ...
        function lost() {
            ...
            $(".score").text(destroyedBricksCount);
             ...
             message3.innerHTML = '<a href="http://funandprizes.com.au" style="color: #B6FFFF;font-size: 30px;">No!</a>';
        ...
        function initGame(event) {
            ...
            //lets append image in SVG
            //var imgs = $(".bottom-Bg").find("img");
        ...
        function startGame(e) { 
            ...
            gameIntervalID = setInterval(function(){gameLoop(e)}, 10);
        }
...
//    }
    ...
    function countdown(event, element) 
    {
        $("#start_show").hide();
