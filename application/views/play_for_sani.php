    ...
    <style>
        ...
        .bottom-Bg img{display: inline-block;margin-left: -4px;width: 117.5px}
        ...
        /*#start_show img {float: right;margin-right: 172px;margin-top: 110px;}*/
            ...
            <audio id="wall_sound" src="<?php echo base_url('SoundFile/Power Up Sound in Power Up Menu.wav')?>" preload="auto" type ="audio/wav"></audio>
...
<!--            <img id="loadingimage" src="images/loader_img.gif" style="display:none;">-->
    ...
    <div class="game_canvas">
        <div class="grid">
           ...
           <div class="bottom-Bg">
              <img style="display:none" src="<?php echo base_url('images/green_brick.1.png'); ?>" class="123" name="123" id="1" data-uid="hello">
              <img style="display:none" id="2" src="<?php echo base_url('images/green_brick.1.png'); ?>" class="123" name="123" data-uid="he">
              <img style="display:none" id="3" src="<?php echo base_url('images/green_brick.1.png'); ?>" class="123" name="123" data-uid="hel">
              <img style="display:none" id="4" src="<?php echo base_url('images/green_brick.1.png'); ?>" class="123" name="123" data-uid="hllo">

              <img style="display:none" src="<?php echo base_url('images/red_brick.png'); ?>" class="123" name="123" id="5" data-uid="hello">
              <img style="display:none" id="6" src="<?php echo base_url('images/red_brick.png'); ?>" class="123" name="123" data-uid="he">
              <img style="display:none" id="7" src="<?php echo base_url('images/red_brick.png'); ?>" class="123" name="123" data-uid="hel">
              <img style="display:none" id="8" src="<?php echo base_url('images/red_brick.png'); ?>" class="123" name="123" data-uid="hllo">

              <img src="<?php echo base_url('images/red_brick.png'); ?>" id="red_show" style="display:none" name="123" data-uid="hllo">
            </div>
        </div>
    </div>
